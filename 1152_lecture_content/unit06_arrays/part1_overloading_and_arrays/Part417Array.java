...
This example contains many useful methods
for you to make use of, but don't be 
surprised if I ask you to write your own
version of these methods at some point.
If the assignment is to write a sorting
method, for example, you cannot just use
Arrays.sort.
*/
import java.util.Arrays;

public class Part417Array
{
