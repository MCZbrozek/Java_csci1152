...
public class Part015Arithmetic {
	public static void main(String[] args) {
		 ...
		 * / division
		 * 
		 * Exponents, roots, absolute value, and more may require the Math library,
		...
		// Use parentheses to specify the order of operations, otherwise, calculations
		// will be made as established in math class.
		result = (4.0 / 6) * (5 - 2);
		...
		// z = 5.0 / 2; //z is an integer. //NOTE TO SELF: This causes an error:
