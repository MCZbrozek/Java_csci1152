...
public class Part005Errors {
	public static void main(String[] args) {
		 ...
		 * Then recompile. You will get an error.
		 * Copy the text of the error here into this comment then put the bracket back
		 * so that the program compiles.
		 */

		// Some of the following examples are from the textbook: Java How to Program,
		// Late Objects Version, Eleventh Edition by Deitel
		 ...
		 * Then recompile. You will get an error.
		 * Copy the text of the error here into this comment then put the parend back so
		 ...
		 * Then recompile. You will get an error.
		 * Copy the text of the error here into this comment then put the quotation mark
		 * back so that the program compiles.
		 */
