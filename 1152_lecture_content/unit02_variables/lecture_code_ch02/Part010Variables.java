...
public class Part010Variables
{
	public static void main(String[] args)
	{
		...
		//its memory location is managed by Java and difficult (and unnecessary) for the programmer to get access to.
		...
		double position; //declaration of a "double", this is a float, but twice as precise, hence double
		...
		//Declaration means telling Java to reserve space in memory to store the specified data type, AND to associate that memory location with the given name.
		...
		//TODO: Declare a double variable named bday and assign it the value [month].[day].
		//For instance, if you were born on March 12th, the value would be 3.12.

		//TODO: Change the value of x to be 109. Do not declare x. Just assign it the value.
		...
		//Variables should be written in "camel case" with later words in the name capitalized, for instance, sumOfTen
		int productOfPrimes;
		int amount1;
		int amount2;
		int twiceAsLarge;
		...
		Copy the text of the error here into this comment then comment out your variable so that the program compiles. */
