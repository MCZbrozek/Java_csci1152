...
public class Part215ClassAverage
{
	public static void main(String[] args)
	{
		...
		/* TODO: Write a while statement on the
		next line of code so that the loop repeats
